...
import { StyleSheet, Text, View, TouchableOpacity, TextInput, Image, ImageBackground, CameraRoll } from "react-native";
...
export default class TransactionScreen extends Component {
    ...
    handleBarCodeScanned = async ({ type, data }) => {
      ...
      initiateBookIssue = () => {
        console.log("Livro emprestado pelo aluno!");
      }

      initiateBookReturn = ()=>{
        console.log("Livro devolvido para a biblioteca!");
      };
